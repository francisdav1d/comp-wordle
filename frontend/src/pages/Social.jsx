          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-surface-container-low p-8 rounded-lg flex flex-col gap-6 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <button className="bg-primary-container text-on-primary-container px-8 py-4 rounded font-headline font-extrabold tracking-tight uppercase text-sm hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-3 w-full sm:w-max shadow-sm border-t border-white/10">
            ...
            <div className="bg-surface-container-low p-8 rounded-lg flex flex-col gap-6 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input className="bg-surface-container-highest border-none focus:ring-1 focus:ring-primary/30 rounded px-4 py-4 font-headline tracking-widest text-lg w-full sm:w-64 placeholder:text-outline/50 placeholder:tracking-normal uppercase outline-none" placeholder="ENTER ROOM CODE" type="text" />
                  <button className="bg-surface-container-highest text-on-surface hover:bg-surface-bright px-8 py-4 rounded font-headline font-extrabold tracking-tight uppercase text-sm active:scale-[0.98] transition-all border-t border-white/5">
                    JOIN MATCH
                  </button>
                </div>
              </div>
