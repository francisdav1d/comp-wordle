    ...
    <main className="relative min-h-[calc(100vh-64px)] flex flex-col md:flex-row overflow-hidden px-6 md:px-12 lg:px-24 items-center bg-[#131314]">
      ...
      <div className="w-full md:w-1/2 z-30 py-8 md:py-24">
        ...
        <div className="flex flex-col space-y-2 max-w-sm mx-auto md:mx-0">
          <NavLink to="/dashboard" className="group flex items-center justify-between bg-[#1c1c1d] text-white px-6 py-5 border border-[#3a3a3c] rounded-md font-black text-[10px] uppercase tracking-[0.3em] transition-all hover:bg-[#252526]">
            <span>Initialize Dashboard</span>
            <span className="material-symbols-outlined text-sm">arrow_forward</span>
          </NavLink>

          <NavLink to="/arena" className="group flex items-center justify-between bg-primary text-[#131314] px-6 py-5 border border-primary rounded-md font-black text-[10px] uppercase tracking-[0.3em] transition-all hover:brightness-110">
            <span>Enter Combat Arena</span>
            <span className="material-symbols-outlined text-sm font-black text-[#131314]">shield</span>
          </NavLink>

          <NavLink to="/social" className="group flex items-center justify-between bg-transparent text-white px-6 py-5 border border-[#3a3a3c] rounded-md font-black text-[10px] uppercase tracking-[0.3em] transition-all hover:bg-[#1c1c1d]">
